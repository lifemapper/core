#!/bin/bash
"""
@summary: This script compresses a PAM
@author: CJ Grady
@version: 4.0.0
@status: beta
...
"""
import argparse
from LmCompute.plugins.multi.compress.compressRunner import CompressRunner
...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="This script compresses a PAM") 
   ...
   job = CompressRunner(args.jobXml, jobName=args.jobName, 
