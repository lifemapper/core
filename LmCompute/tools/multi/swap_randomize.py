#!/bin/bash
"""
@summary: This script randomizes a PAM using the Gotelli swap method while
...
"""
import argparse
from LmCompute.plugins.multi.randomize.randomizeRunners import RandomizeSwapRunner
...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="This script randomizes a PAM using the Gotelli Swap method while maintaining marginal totals") 
   ...
   job = RandomizeSwapRunner(args.jobXml, jobName=args.jobName, 
