...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="This script attempts to generate a Maxent model from the given Lifemapper inputs") 
   ...
   job = MEModelRunner(args.jobXml, jobName=args.jobName, outDir=args.outDir, 
