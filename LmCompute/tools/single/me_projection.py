...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="This script attempts to generate a Maxent projection from the given Lifemapper inputs") 
   ...
   job = MEProjectionRunner(args.jobXml, jobName=args.jobName, outDir=args.outDir, 
