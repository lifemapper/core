#!/bin/bash
"""
@summary: This script attempts to generate an openModeller projection from the 
             given Lifemapper inputs
@author: CJ Grady
@version: 4.0.0
@status: beta
...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="This script attempts to generate an openModeller projection from the given Lifemapper inputs") 
   ...
   job = OMProjectionRunner(args.jobXml, jobName=args.jobName, outDir=args.outDir, 
