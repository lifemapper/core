...
class IdigbioQueryCommand(_LmCommand):
    ...
    def __init__(self, taxon_id_file, point_output_file, meta_output_file,
        ...
        self.posArgs = '{} {} {}'.format(taxon_id_file, point_output_file, 
                                         meta_output_file)
        self.optArgs = ''
        if missing_id_file is not None:
            self.optArgs = '--missing_id_file {}'.format(missing_id_file)
    ...
    def getCommand(self):
        ...
        """
        return '{} {} {} {}'.format(CMD_PYBIN, self.getScript(), self.posArgs, 
                                 self.optArgs)
