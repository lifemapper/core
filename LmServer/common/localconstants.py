...
PUBLIC_USER = cfg.get(_ENV_CONFIG_HEADING, 'PUBLIC_USER')
...
SCENARIO_PACKAGE_EPSG = cfg.getint(_PIPELINE_CONFIG_HEADING, 'SCENARIO_PACKAGE_EPSG')
SCENARIO_PACKAGE_MAPUNITS = cfg.get(_PIPELINE_CONFIG_HEADING, 'SCENARIO_PACKAGE_MAPUNITS')
