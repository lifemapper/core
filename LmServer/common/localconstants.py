...
UPLOAD_PATH = cfg.get(_ENV_CONFIG_HEADING, 'UPLOAD_PATH')
LOG_PATH = cfg.get(_ENV_CONFIG_HEADING, 'LOG_PATH')
TEMP_PATH = cfg.get(_ENV_CONFIG_HEADING, 'TEMP_PATH')
MAPSERVER_ROOT = cfg.get(_ENV_CONFIG_HEADING, 'MAPSERVER_ROOT')
...
# MattDaemon
MATT_DAEMON_PID_FILE = cfg.get(_MATT_DAEMON_HEADING, 'MATT_DAEMON_PID_FILE')

# Catalog Server
CATALOG_SERVER_BIN = cfg.get(_MATT_DAEMON_HEADING, 'CS_BIN')
...
# Worker Factory
WORKER_FACTORY_BIN = cfg.get(_MATT_DAEMON_HEADING, 'WF_BIN')
...
MAKEFLOW_BIN = cfg.get(_MATT_DAEMON_HEADING, 'MAKEFLOW_BIN')
