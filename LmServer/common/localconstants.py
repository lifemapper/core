...
UPLOAD_PATH = Config().get(_ENV_CONFIG_HEADING, 'UPLOAD_PATH')
LOG_PATH = Config().get(_ENV_CONFIG_HEADING, 'LOG_PATH')
...
# MattDaemon
MATT_DAEMON_PID_FILE = Config().get(_MATT_DAEMON_HEADING, 'MATT_DAEMON_PID_FILE')

# Catalog Server
CATALOG_SERVER_BIN = Config().get(_MATT_DAEMON_HEADING, 'CS_BIN')
CATALOG_SERVER_PID_FILE = Config().get(_MATT_DAEMON_HEADING, 'CS_PID_FILE')
CATALOG_SERVER_OPTIONS = Config().get(_MATT_DAEMON_HEADING, 'CS_OPTIONS')

# Worker Factory
WORKER_FACTORY_BIN = Config().get(_MATT_DAEMON_HEADING, 'WF_BIN')
WORKER_FACTORY_OPTIONS = Config().get(_MATT_DAEMON_HEADING, 'WF_OPTIONS')

# Makeflow
MAX_MAKEFLOWS = Config().getint(_MATT_DAEMON_HEADING, 'MAX_MAKEFLOWS')
MAKEFLOW_BIN = Config().get(_MATT_DAEMON_HEADING, 'MAKEFLOW_BIN')
MAKEFLOW_OPTIONS = Config().get(_MATT_DAEMON_HEADING, 'MAKEFLOW_OPTIONS')
