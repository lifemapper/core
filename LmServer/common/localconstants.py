...
OGC_SERVICE_URL = cfg.get(SERVER_ENV_HEADING, 'OGC_SERVICE_URL')
...
SCENARIO_PACKAGE_EPSG = cfg.getint(SERVER_PIPELINE_HEADING, 'SCENARIO_PACKAGE_EPSG')
SCENARIO_PACKAGE_MAPUNITS = cfg.get(SERVER_PIPELINE_HEADING, 'SCENARIO_PACKAGE_MAPUNITS')

CONNECTION_PORT = int(cfg.get(SERVER_DB_HEADING, 'CONNECTION_PORT'))
DB_HOSTNAME = cfg.get(SERVER_DB_HEADING, 'DB_HOSTNAME')

# Catalog Server
CATALOG_SERVER_PID_FILE = cfg.get(SERVER_MATT_DAEMON_HEADING, 'CS_PID_FILE')
CATALOG_SERVER_OPTIONS = cfg.get(SERVER_MATT_DAEMON_HEADING, 'CS_OPTIONS')

# Worker Factory
WORKER_FACTORY_OPTIONS = cfg.get(SERVER_MATT_DAEMON_HEADING, 'WF_OPTIONS')

# Makeflow
MAX_MAKEFLOWS = cfg.getint(SERVER_MATT_DAEMON_HEADING, 'MAX_MAKEFLOWS')
MAKEFLOW_OPTIONS = cfg.get(SERVER_MATT_DAEMON_HEADING, 'MAKEFLOW_OPTIONS')
