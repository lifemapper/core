...
from LmServer.common.lmconstants import SOLR_FIELDS, HTTPStatus
...
class GlobalPAMService(LmService):
    ...
    def subset_global_pam(
        ...
        """Queries the Global PAM and returns a subset of intersected layers (PAVs) matching the parameters
    ...
    # ................................
    @lm_formatter
    def post_global_pam_subset(self, user_id, archive_name, gridset_id, algorithm_code=None, bbox=None,
        cell_size=None, model_scenario_code=None, point_max=None,
             point_min=None, user_id=None, prj_scen_code=None, squid=None,
        ...
        """Queries the Global PAM, and creates a gridset initializing a new PAM from layers matching the parameters, 
        ...
        gridset = self._subset_global_pam(archive_name, matches, bbox=bbox, cell_size=cell_size)
        HTTPStatus.ACCEPTED
        return Atom(
