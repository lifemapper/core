...
class OccurrenceLayerService(LmService):
    ...
    # ................................
    @lm_formatter
    def filter_occurrence_sets(self, path_occset_id=None, after_time=None, before_time=None,
    ...
    # ................................
    def get_occurrence_set(self, path_occset_id, fill_points=False):
        """Attempt to get an occurrence set"""
        occ = self.scribe.get_occurrence_set(occ_id=int(path_occset_id))

        if occ is None:
            raise NotFound('Occurrence set not found')
        ...
        raise Forbidden('User {} does not have permission to GET occurrence set'.format(
                self.get_user_id()))
