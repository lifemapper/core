...
var _user$project$AncStateTreeView$view = function (model) {
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Ancestral data for Selected Node'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
	...
	return A7(_user$project$MultiSpeciesView$view, model, tableHead, false, _user$project$AncStateTreeView$variableFormatter, model.variables, selectData, dataForVar);
};
