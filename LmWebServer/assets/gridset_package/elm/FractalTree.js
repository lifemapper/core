...
var _user$project$TreeZipper$getTree = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _user$project$TreeZipper$getData = function (zipper) {
	var _p2 = _user$project$TreeZipper$getTree(zipper);
	if (_p2.ctor === 'Leaf') {
		return _p2._0;
	} else {
		return _p2._0;
...
var _user$project$TreeZipper$RightBranch = {ctor: 'RightBranch'};
var _user$project$TreeZipper$LeftBranch = {ctor: 'LeftBranch'};
var _user$project$TreeZipper$Root = {ctor: 'Root'};
var _user$project$TreeZipper$getPosition = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._1;
	switch (_p5.ctor) {
		case 'Top':
			return _user$project$TreeZipper$Root;
		case 'Left':
			return _user$project$TreeZipper$LeftBranch;
		default:
			return _user$project$TreeZipper$RightBranch;
	}
};
var _user$project$TreeZipper$Right = F3(
	function (a, b, c) {
		return {ctor: 'Right', _0: a, _1: b, _2: c};
	});
var _user$project$TreeZipper$Left = F3(
	function (a, b, c) {
		return {ctor: 'Left', _0: a, _1: b, _2: c};
	});
var _user$project$TreeZipper$Top = {ctor: 'Top'};
var _user$project$TreeZipper$TreeZipper = F2(
	function (a, b) {
		return {ctor: 'TreeZipper', _0: a, _1: b};
	});
var _user$project$TreeZipper$start = function (tree) {
	return A2(_user$project$TreeZipper$TreeZipper, tree, _user$project$TreeZipper$Top);
};
var _user$project$TreeZipper$left = function (_p6) {
	var _p7 = _p6;
	var _p8 = _p7._0;
	if (_p8.ctor === 'Node') {
		return A2(
			_user$project$TreeZipper$TreeZipper,
			_p8._1,
			A3(_user$project$TreeZipper$Left, _p8._0, _p7._1, _p8._2));
	} else {
		return _p7;
	}
};
var _user$project$TreeZipper$right = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10._0;
	if (_p11.ctor === 'Node') {
		return A2(
			_user$project$TreeZipper$TreeZipper,
			_p11._2,
			A3(_user$project$TreeZipper$Right, _p11._0, _p11._1, _p10._1));
	} else {
		return _p10;
	}
};
var _user$project$TreeZipper$up = function (_p12) {
	var _p13 = _p12;
	var _p15 = _p13._0;
	var _p14 = _p13._1;
	switch (_p14.ctor) {
		...
		case 'Left':
			return A2(
				_user$project$TreeZipper$TreeZipper,
				A3(_user$project$DecodeTree$Node, _p14._0, _p15, _p14._2),
				_p14._1);
		default:
			return A2(
				_user$project$TreeZipper$TreeZipper,
				A3(_user$project$DecodeTree$Node, _p14._0, _p14._1, _p15),
				_p14._2);
	}
};
var _user$project$TreeZipper$moveToward = F2(
	function (dir, zipper) {
		var _p16 = dir;
		switch (_p16.ctor) {
			case 'Root':
				return _user$project$TreeZipper$up(zipper);
			case 'LeftBranch':
				return _user$project$TreeZipper$left(zipper);
			default:
				return _user$project$TreeZipper$right(zipper);
		}
	});
...
var _user$project$FractalTreeModel$Flags = F3(
	function (a, b, c) {
		return {mcpaMatrix: a, taxonTree: b, ancState: c};
	});
var _user$project$FractalTreeModel$TreeInfo = F4(
	function (a, b, c, d) {
		return {root: a, length: b, depth: c, breadth: d};
	});
var _user$project$FractalTreeModel$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {zipper: a, treeInfo: b, mcpaVariables: c, ancStateVars: d, ancState: e, mcpaData: f, selectedVariable: g, selectedNode: h, showBranchLengths: i, animationState: j, mouseIn: k};
										};
									};
								};
							};
...
var _user$project$FractalTreeModel$Static = {ctor: 'Static'};
var _user$project$FractalTreeModel$init = function (flags) {
	var root = function () {
		var _p0 = _user$project$ParseNexusTree$parseNexusTree(flags.taxonTree);
		if (_p0.ctor === 'Ok') {
			return _p0._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'FractalTreeModel',
				{
					...
					end: {line: 94, column: 76}
				},
				_p0)(
				A2(_elm_lang$core$Basics_ops['++'], 'failed parsing Nexus tree data: ', _p0._0));
		}
	}();
	var treeInfo = {
		root: root,
	...
	var _p2 = function () {
		var _p3 = _user$project$ParseAncState$parseAncState(flags.ancState);
		if (_p3.ctor === 'Ok') {
			return _p3._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'FractalTreeModel',
				{
					...
					end: {line: 86, column: 78}
				},
				_p3)(
				A2(_elm_lang$core$Basics_ops['++'], 'failed to decode ancState matrix: ', _p3._0));
		}
	}();
	var ancStateVars = _p2._0;
	var ancState = _p2._1;
	var _p5 = function () {
		var _p6 = _user$project$ParseMcpa$parseMcpa(flags.mcpaMatrix);
		if (_p6.ctor === 'Ok') {
			return _p6._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'FractalTreeModel',
				{
					...
					end: {line: 78, column: 74}
				},
				_p6)(
				A2(_elm_lang$core$Basics_ops['++'], 'failed to decode MCPA matrix: ', _p6._0));
		}
	}();
	var variables = _p5._0;
	var data = _p5._1;
	return {
		ctor: '_Tuple2',
		_0: {
			animationState: _user$project$FractalTreeModel$Static,
			zipper: _user$project$TreeZipper$start(root),
			treeInfo: treeInfo,
...
var _user$project$FractalTreeModel$Running = F3(
	function (a, b, c) {
		return {ctor: 'Running', _0: a, _1: b, _2: c};
	});
var _user$project$FractalTreeModel$Start = function (a) {
	return {ctor: 'Start', _0: a};
};
var _user$project$FractalTreeModel$AnimateRight = {ctor: 'AnimateRight'};
var _user$project$FractalTreeModel$AnimateLeft = {ctor: 'AnimateLeft'};
var _user$project$FractalTreeModel$AnimateUpRight = {ctor: 'AnimateUpRight'};
var _user$project$FractalTreeModel$AnimateUpLeft = {ctor: 'AnimateUpLeft'};
var _user$project$FractalTreeModel$updateAnimation = F2(
	function (msg, _p8) {
		var _p9 = _p8;
		var _p21 = _p9.zipper;
		var _p20 = _p9;
		var _p10 = _p9.animationState;
		switch (_p10.ctor) {
			case 'Static':
				var _p11 = msg;
				_v5_3:
				do {
					if (_p11.ctor === 'KeyUp') {
						switch (_p11._0) {
							case 'ArrowDown':
								var _p12 = _user$project$TreeZipper$getPosition(_p21);
								switch (_p12.ctor) {
									case 'LeftBranch':
										return {
											ctor: '_Tuple2',
											_0: _elm_lang$core$Native_Utils.update(
												_p20,
												{
													animationState: _user$project$FractalTreeModel$Start(_user$project$FractalTreeModel$AnimateUpLeft)
												}),
											_1: _elm_lang$core$Platform_Cmd$none
										};
									case 'RightBranch':
										return {
											...
											_0: _elm_lang$core$Native_Utils.update(
												_p20,
												{
													animationState: _user$project$FractalTreeModel$Start(_user$project$FractalTreeModel$AnimateUpRight)
												}),
											_1: _elm_lang$core$Platform_Cmd$none
										};
									default:
							...
							case 'ArrowLeft':
								return (!_elm_lang$core$Native_Utils.eq(
									_p21,
									A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$LeftBranch, _p21))) ? {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										_p20,
										{
											animationState: _user$project$FractalTreeModel$Start(_user$project$FractalTreeModel$AnimateLeft)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
							...
							case 'ArrowRight':
								return (!_elm_lang$core$Native_Utils.eq(
									_p21,
									A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$RightBranch, _p21))) ? {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										_p20,
										{
											animationState: _user$project$FractalTreeModel$Start(_user$project$FractalTreeModel$AnimateRight)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								} : {ctor: '_Tuple2', _0: _p20, _1: _elm_lang$core$Platform_Cmd$none};
							default:
			...
			case 'Start':
				var _p13 = msg;
				if (_p13.ctor === 'CurrentTick') {
					var _p14 = _p13._0;
					var animation = A2(
						_mgold$elm_animation$Animation$ease,
						_elm_community$easing_functions$Ease$inOutCirc,
						A2(
							_mgold$elm_animation$Animation$duration,
							0.5 * _elm_lang$core$Time$second,
							_mgold$elm_animation$Animation$animation(_p14)));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p20,
							{
								animationState: A3(_user$project$FractalTreeModel$Running, _p10._0, _p14, animation)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			default:
				...
				var _p18 = _p10._2;
				var _p15 = msg;
				if (_p15.ctor === 'CurrentTick') {
					var _p17 = _p15._0;
					if (A2(_mgold$elm_animation$Animation$isRunning, _p17, _p18)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								_p20,
								{
									animationState: A3(_user$project$FractalTreeModel$Running, _p19, _p17, _p18)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
							...
							case 'AnimateUpLeft':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											animationState: _user$project$FractalTreeModel$Static,
											zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$Root, _p21)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							case 'AnimateUpRight':
							...
							case 'AnimateLeft':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											animationState: _user$project$FractalTreeModel$Static,
											zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$LeftBranch, _p21)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							default:
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										...
										{
											animationState: _user$project$FractalTreeModel$Static,
											zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$RightBranch, _p21)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
						}
...
var _user$project$FractalTreeModel$update = F2(
	function (msg, model) {
		var _p22 = msg;
		switch (_p22.ctor) {
			case 'SetMouseIn':
			...
			case 'JumpUp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$Root, model.zipper)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'JumpLeft':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$LeftBranch, model.zipper)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'JumpRight':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							zipper: A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$RightBranch, model.zipper)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectVariable':
			...
			case 'SelectNode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedNode: _elm_lang$core$Maybe$Just(_p22._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(_user$project$FractalTreeModel$updateAnimation, _p22._0, model);
		}
	});
var _user$project$FractalTreeModel$AnimationMsg = function (a) {
	return {ctor: 'AnimationMsg', _0: a};
};
var _user$project$FractalTreeModel$SelectNode = function (a) {
	return {ctor: 'SelectNode', _0: a};
};
var _user$project$FractalTreeModel$ToggleShowLengths = {ctor: 'ToggleShowLengths'};
var _user$project$FractalTreeModel$SelectVariable = function (a) {
	return {ctor: 'SelectVariable', _0: a};
};
var _user$project$FractalTreeModel$JumpRight = {ctor: 'JumpRight'};
var _user$project$FractalTreeModel$JumpLeft = {ctor: 'JumpLeft'};
var _user$project$FractalTreeModel$JumpUp = {ctor: 'JumpUp'};
var _user$project$FractalTreeModel$SetMouseIn = function (a) {
	return {ctor: 'SetMouseIn', _0: a};
};
var _user$project$FractalTreeModel$CurrentTick = function (a) {
	return {ctor: 'CurrentTick', _0: a};
};
var _user$project$FractalTreeModel$subscriptions = function (model) {
	var _p23 = model.animationState;
	switch (_p23.ctor) {
		case 'Start':
			return _elm_lang$animation_frame$AnimationFrame$times(
				function (_p24) {
					return _user$project$FractalTreeModel$AnimationMsg(
						_user$project$FractalTreeModel$CurrentTick(_p24));
				});
		case 'Running':
			return _elm_lang$animation_frame$AnimationFrame$times(
				function (_p25) {
					return _user$project$FractalTreeModel$AnimationMsg(
						_user$project$FractalTreeModel$CurrentTick(_p25));
				});
		default:
			return _elm_lang$core$Platform_Sub$none;
	}
};
var _user$project$FractalTreeModel$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};

var _user$project$FractalTreeView$clickBoxes = {
	ctor: '::',
	_0: A2(
		_elm_lang$svg$Svg$rect,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width('0.5'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height('0.9'),
						_1: {
							ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$FractalTreeModel$AnimationMsg(
													_user$project$FractalTreeModel$KeyUp('ArrowLeft'))),
											_1: {ctor: '[]'}
										}
									}
								}
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$FractalTreeModel$AnimationMsg(
														_user$project$FractalTreeModel$KeyUp('ArrowRight'))),
												_1: {ctor: '[]'}
											}
										}
									}
		...
		_1: {
			...
			_0: A2(
				_elm_lang$svg$Svg$rect,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y('0.4'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width('1'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$height('0.1'),
								_1: {
									ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$FractalTreeModel$AnimationMsg(
															_user$project$FractalTreeModel$KeyUp('ArrowDown'))),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$FractalTreeView$drawTree_ = F3(
	function (depth, quadrant, tree) {
		var textTransform = (_elm_lang$core$Native_Utils.cmp(quadrant, 2) < 0) ? 'rotate(90)' : 'rotate(-90)';
		var descend = function (depth) {
			var _p0 = tree;
			if (_p0.ctor === 'Leaf') {
				return {
					ctor: '::',
						...
						_elm_lang$svg$Svg$ellipse,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$ry('0.3'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$fill('green'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$stroke('lightgreen'),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$strokeWidth('0.005'),
													_1: {ctor: '[]'}
												}
											}
										}
					...
					_1: {
						...
						_0: A2(
							_elm_lang$svg$Svg$text_,
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$fontSize('0.05'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$transform(textTransform),
												_1: {
													ctor: '::',
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg$text(_p0._0.name),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x1('-0.25'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x2('0.25'),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$stroke('darkolivegreen'),
											_1: {
												ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$transform('translate(-0.25, 0) scale(0.7) rotate(-90)'),
								_1: {ctor: '[]'}
							},
							A3(
								_user$project$FractalTreeView$drawTree_,
								depth,
								A2(_elm_lang$core$Basics_ops['%'], quadrant + 1, 4),
								_p0._1)),
						_1: {
							ctor: '::',
							_0: A2(
		...
		return (_elm_lang$core$Native_Utils.cmp(depth, 11) < 0) ? descend(depth + 1) : {ctor: '[]'};
	});
var _user$project$FractalTreeView$drawTree = F2(
	function (trans, tree) {
		return A2(
			_elm_lang$svg$Svg$g,
			{
			...
			},
			{
				...
				_0: A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$strokeWidth('0.014'),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					{ctor: '[]'}),
				_1: A3(_user$project$FractalTreeView$drawTree_, 0, 0, tree)
			});
	});
var _user$project$FractalTreeView$transformToAttr = function (t) {
	var _p1 = t;
	switch (_p1.ctor) {
		case 'Translate':
			return A2(
...
var _user$project$FractalTreeView$Rotate = function (a) {
	return {ctor: 'Rotate', _0: a};
};
var _user$project$FractalTreeView$Scale = function (a) {
	return {ctor: 'Scale', _0: a};
};
var _user$project$FractalTreeView$Translate = function (a) {
	return {ctor: 'Translate', _0: a};
};
var _user$project$FractalTreeView$view = function (_p2) {
	var _p3 = _p2;
	var _p15 = _p3.zipper;
	var _p4 = function () {
		var _p5 = _p3.animationState;
		switch (_p5.ctor) {
			case 'Static':
				return {
					ctor: '_Tuple3',
					_0: {ctor: '[]'},
					_1: _user$project$TreeZipper$getTree(_p15),
					_2: function (_) {
						return _.cladeId;
					}(
						_user$project$TreeZipper$getData(_p15))
				};
			case 'Start':
				return {
					ctor: '_Tuple3',
			...
			default:
				switch (_p5._0.ctor) {
					case 'AnimateLeft':
						...
						var transforms = {
							ctor: '::',
							_0: _user$project$FractalTreeView$Rotate(
								A2(
									...
									A2(
										...
										90,
										A2(_mgold$elm_animation$Animation$from, 0, _p6)))),
							_1: {
								ctor: '::',
								_0: _user$project$FractalTreeView$Scale(
									1.0 / A2(
										_mgold$elm_animation$Animation$animate,
										_p7,
										A2(
											_mgold$elm_animation$Animation$to,
											0.7,
											A2(_mgold$elm_animation$Animation$from, 1, _p6)))),
								_1: {
									ctor: '::',
									_0: _user$project$FractalTreeView$Translate(
										A2(
											_mgold$elm_animation$Animation$animate,
											_p7,
											A2(
							...
							_0: _user$project$FractalTreeView$Rotate(
								A2(
									...
									A2(
										_mgold$elm_animation$Animation$to,
										-90,
										A2(_mgold$elm_animation$Animation$from, 0, _p8)))),
							_1: {
								ctor: '::',
								_0: _user$project$FractalTreeView$Scale(
									1.0 / A2(
										...
										A2(
											_mgold$elm_animation$Animation$to,
											0.7,
											A2(_mgold$elm_animation$Animation$from, 1, _p8)))),
								_1: {
									ctor: '::',
									_0: _user$project$FractalTreeView$Translate(
										A2(
					...
					case 'AnimateUpLeft':
							...
							_0: _user$project$FractalTreeView$Rotate(
								A2(
									...
									A2(
										_mgold$elm_animation$Animation$to,
										0,
										A2(_mgold$elm_animation$Animation$from, 90, _p10)))),
							_1: {
								ctor: '::',
								_0: _user$project$FractalTreeView$Scale(
									1.0 / A2(
										...
										A2(
											_mgold$elm_animation$Animation$to,
											1,
											A2(_mgold$elm_animation$Animation$from, 0.7, _p10)))),
								_1: {
									ctor: '::',
									_0: _user$project$FractalTreeView$Translate(
										A2(
											...
											A2(
												_mgold$elm_animation$Animation$to,
												0,
												A2(_mgold$elm_animation$Animation$from, 0.25, _p10)))),
									_1: {ctor: '[]'}
								}
							}
						};
						return {
							ctor: '_Tuple3',
							_0: transforms,
							_1: _user$project$TreeZipper$getTree(
								A2(_user$project$TreeZipper$moveToward, _user$project$TreeZipper$Root, _p15)),
							_2: function (_) {
								return _.cladeId;
							}(
								_user$project$TreeZipper$getData(_p15))
							...
							_0: _user$project$FractalTreeView$Rotate(
								A2(
									...
									A2(
										_mgold$elm_animation$Animation$to,
										0,
										A2(_mgold$elm_animation$Animation$from, -90, _p12)))),
							_1: {
								ctor: '::',
								_0: _user$project$FractalTreeView$Scale(
									1.0 / A2(
										...
										A2(
											_mgold$elm_animation$Animation$to,
											1,
											A2(_mgold$elm_animation$Animation$from, 0.7, _p12)))),
								_1: {
									ctor: '::',
									_0: _user$project$FractalTreeView$Translate(
										A2(
											...
											A2(
												_mgold$elm_animation$Animation$to,
												0,
												A2(_mgold$elm_animation$Animation$from, -0.25, _p12)))),
									_1: {ctor: '[]'}
								}
							}
						};
	...
	var transforms = _p4._0;
	var tree = _p4._1;
	var mapClade = _p4._2;
	var cbx = _p3.mouseIn ? _user$project$FractalTreeView$clickBoxes : {ctor: '[]'};
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: A2(
				...
				A2(
					...
					function (_p14) {
						return _user$project$FractalTreeModel$AnimationMsg(
							_user$project$FractalTreeModel$KeyUp(_p14));
					},
			...
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$viewBox('-0.5 -0.5 1 1'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onMouseEnter(
										_user$project$FractalTreeModel$SetMouseIn(true)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onMouseLeave(
											_user$project$FractalTreeModel$SetMouseIn(false)),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				},
				{
					ctor: '::',
					_0: A2(
						_user$project$FractalTreeView$drawTree,
						A2(
							_elm_lang$core$String$join,
							' ',
							A2(_elm_lang$core$List$map, _user$project$FractalTreeView$transformToAttr, transforms)),
						tree),
					_1: cbx
				}),
			_1: {
					...
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html_Attributes$attribute,
								'data-map-column',
								_elm_lang$core$Basics$toString(mapClade)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
...
var _user$project$FractalTreeMain$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$FractalTreeModel$init, update: _user$project$FractalTreeModel$update, view: _user$project$FractalTreeView$view, subscriptions: _user$project$FractalTreeModel$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (ancState) {
			return A2(
				...
				function (mcpaMatrix) {
					return A2(
						...
						function (taxonTree) {
							return _elm_lang$core$Json_Decode$succeed(
								{ancState: ancState, mcpaMatrix: mcpaMatrix, taxonTree: taxonTree});
						},
						A2(_elm_lang$core$Json_Decode$field, 'taxonTree', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'mcpaMatrix', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'ancState', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['FractalTreeMain'] = Elm['FractalTreeMain'] || {};
if (typeof _user$project$FractalTreeMain$main !== 'undefined') {
    _user$project$FractalTreeMain$main(Elm['FractalTreeMain'], 'FractalTreeMain', undefined);
}
