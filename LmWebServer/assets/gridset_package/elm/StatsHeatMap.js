...
var _user$project$StatsHeatMap$rangeFormat = function (value) {
	return A2(
		_krisajenkins$formatting$Formatting$print,
		_krisajenkins$formatting$Formatting$roundTo(1),
		value);
};
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Site Based Statistics'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Currently mapping: '),
								_1: {
									ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Heat Map'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															A2(
																_elm_lang$core$Maybe$map,
																function (_p4) {
																	return _user$project$StatsHeatMap$rangeFormat(
																		function (_) {
																			return _.min;
																		}(_p4));
																},
