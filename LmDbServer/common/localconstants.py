...
SCENARIO_PACKAGE = Config().get(SERVER_PIPELINE_HEADING, 
                                'SCENARIO_PACKAGE')
SCENARIO_PACKAGE_MODEL_SCENARIO = Config().get(SERVER_PIPELINE_HEADING, 
                                               'SCENARIO_PACKAGE_MODEL_SCENARIO')
SCENARIO_PACKAGE_PROJECTION_SCENARIOS = Config().getlist(SERVER_PIPELINE_HEADING, 
...
USER_OCCURRENCE_DATA = Config().get(SERVER_PIPELINE_HEADING, 
...
# iDigBio data
IDIG_FILENAME = Config().get(SERVER_PIPELINE_HEADING, 'IDIG_FILENAME')
