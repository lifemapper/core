...
ALGORITHMS = Config().getlist(_CONFIG_HEADING, 'ALGORITHMS')
GRID_NAME = Config().get(_CONFIG_HEADING, 'GRID_NAME')
GRID_CELLSIZE = Config().get(_CONFIG_HEADING, 'GRID_CELLSIZE')

SCENARIO_PACKAGE = Config().get(_CONFIG_HEADING, 'SCENARIO_PACKAGE')
SCENARIO_PACKAGE_MODEL_SCENARIO = Config().get(_CONFIG_HEADING, 
                                             'SCENARIO_PACKAGE_MODEL_SCENARIO')
SCENARIO_PACKAGE_PROJECTION_SCENARIOS = Config().getlist(_CONFIG_HEADING, 
