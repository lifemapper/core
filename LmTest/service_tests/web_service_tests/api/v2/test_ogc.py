...
Note:
    * These tests use the client library (filled in by pytest) to retrieve
...
class Test_ogc_services_public(object):
    ...
    """
    # .....................................
    def test_occurrence_map(self, client):
        ...
        """
        occ_list = client.deserialize(
            client.list_occurrence_sets(status=JobStatus.COMPLETE))
        occ_id = occ_list[0]['id']
        occ = client.deserialize(client.get_occurrence_set(occ_id))
    ...
    # .....................................
    def test_projection_data(self, client):
        ...
        Todo:
            ...
            * Use multiple image formats
        """
        prj_list = client.deserialize(
            client.list_sdm_projections(status=JobStatus.COMPLETE))
        prj_id = prj_list[0]['id']
        prj = client.deserialize(client.get_sdm_projection(prj_id))
    ...
    # .....................................
    def test_projection_map(self, client):
