"""
@summary: This module contains functions for wrapping CherryPy interactions
@author: CJ Grady
@version: 1.0
@status: beta
@license: gpl2
@copyright: Copyright (C) 2015, University of Kansas Center for Research
          ...
          02110-1301, USA.
@note: This was written using CherryPy 3.1.2
@note: Based this on https://bitbucket.org/Lawouach/cherrypy-recipes/src/tip/testing/unit/serverless/
"""
import cherrypy
import os
import pickle
...
class AppWrapper(object):
   ...
   @summary: This is a wrapper class around the cherrypy application we will
                use for direct debugging.  This class is a singleton so that we
                always work with the same one in a single debugging run.  I did
                this in case there were issues with sessions across instances
                and so that we don't keep resetting session options
   """
   # ..............................
   def __init__(self):
